...
//                        startActivity(foodDetail);
                        configDialogFoodDetail(model, searchadapter.getRef(viewHolder.getAdapterPosition()).getKey());
                    }
                });
            }
        };
...
//                        startActivity(foodDetail);
                        configDialogFoodDetail(model, adapter.getRef(viewHolder.getAdapterPosition()).getKey());
